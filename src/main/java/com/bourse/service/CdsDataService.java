...
public class CdsDataService {
    ...
    public void doCalculationLoader(String fromDate,String toDate)
   	{
   		StoredProcedureQuery query = this.entityManager.createStoredProcedureQuery("calculation_cds_loader");
	...
	public void updateValue(String date, Long subgroupId, String value) {
		...
		CdsData entity = CdsDataRepository.findByReferDateAndSubgroupId(date, subgroupId);

		if (entity != null) {

			entity.setValue(value);

			CdsDataRepository.save(entity);
		}
	}
}
