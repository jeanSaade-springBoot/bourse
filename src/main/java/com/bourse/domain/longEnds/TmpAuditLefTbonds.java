...
@AllArgsConstructor
@Entity
@Table(name = "tmp_audit_lef_tbonds")
public class TmpAuditLefTbonds {
	@Id
	@GeneratedValue(generator = "audit_lef_tbonds_sequence")
	   @GenericGenerator(
	      name = "audit_lef_tbonds_sequence",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "audit_lef_tbonds_sequence"),
