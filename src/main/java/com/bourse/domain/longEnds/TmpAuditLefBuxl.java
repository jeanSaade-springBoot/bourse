...
@AllArgsConstructor
@Entity
@Table(name = "tmp_audit_lef_buxl")
public class TmpAuditLefBuxl {
	@Id
	@GeneratedValue(generator = "audit_lef_buxl_sequence")
	   @GenericGenerator(
	      name = "audit_lef_buxl_sequence",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "audit_lef_buxl_sequence"),
