...
@AllArgsConstructor
@Entity
@Table(name = "tmp_audit_lef_shatz")
public class TmpAuditLefShatz {
	@Id
	@GeneratedValue(generator = "audit_lef_shatz_sequence")
	   @GenericGenerator(
	      name = "audit_lef_shatz_sequence",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "audit_lef_shatz_sequence"),
