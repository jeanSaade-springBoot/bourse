...
@AllArgsConstructor
@Entity
@Table(name = "tmp_audit_lef_btp")
public class TmpAuditLefBtp {
	@Id
	@GeneratedValue(generator = "audit_lef_btp_sequence")
	   @GenericGenerator(
	      name = "audit_lef_btp_sequence",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "audit_lef_btp_sequence"),
