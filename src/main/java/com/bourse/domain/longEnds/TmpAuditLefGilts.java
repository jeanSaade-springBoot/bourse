...
@AllArgsConstructor
@Entity
@Table(name = "tmp_audit_lef_gilts")
public class TmpAuditLefGilts {
	@Id
	@GeneratedValue(generator = "audit_lef_gilts_sequence")
	   @GenericGenerator(
	      name = "audit_lef_gilts_sequence",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "audit_lef_gilts_sequence"),
