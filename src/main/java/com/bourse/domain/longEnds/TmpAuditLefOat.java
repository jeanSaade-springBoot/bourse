...
@AllArgsConstructor
@Entity
@Table(name = "tmp_audit_lef_oat")
public class TmpAuditLefOat {
	@Id
	@GeneratedValue(generator = "audit_lef_oat_sequence")
	   @GenericGenerator(
	      name = "audit_lef_oat_sequence",
	      strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
	      parameters = {
	        @Parameter(name = "sequence_name", value = "audit_lef_oat_sequence"),
