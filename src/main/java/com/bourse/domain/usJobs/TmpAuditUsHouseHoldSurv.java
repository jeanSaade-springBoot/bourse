...
@AllArgsConstructor
@Entity
@Table(name = "tmp_audit_us_householdsurv")
public class TmpAuditUsHouseHoldSurv {
	@Id
	...
	private Long id;
	private String civilianLabForce;
	private String civilianLabForceChg;
	private String employedLabForce;
	private String employedLabForceChg;
