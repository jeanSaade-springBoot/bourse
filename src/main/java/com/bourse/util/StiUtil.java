...
public class StiUtil {
	...
	public static QueryColumnsDTO buildDynamicGridQuery(MainSearchFilterDTO mainSearchFilterDTO)
	{
		 ...
		 {
			if(selectedSearchDTO.getGroupId() == 32) 
			{if(counter == 1)
			 {
			 ...
			 for(String value : selectedSearchDTO.getSelectedValues())
			 {
					 ...
					 forUsetables = forUsetables + tableSchema+"tmp_audit_sti_asia ";
				...
				if(selectedSearchDTO.getGroupId() == 33) 
				{
				if(counter == 1)
				 {
					 forUseSelect = "select DATE_FORMAT(STR_TO_DATE(s"+counter+".refer_date, '%d-%m-%Y'), '%m-%d-%Y') as refer_date";
				 ...
				 for(String value : selectedSearchDTO.getSelectedValues())
				 {
						 ...
						 forUsetables = forUsetables + tableSchema+"tmp_audit_sti_wall_street";
	    				 forUsetables = forUsetables + " s"+counter+" ,";
					 	 forUseSelect = forUseSelect+", \n"+ 
						                         " s"+counter+"."+value+
								         " as '"+value+"'";
					...
					if(selectedSearchDTO.getGroupId() == 34) 
					{
					if(counter == 1)
					 {
						 forUseSelect = "select DATE_FORMAT(STR_TO_DATE(s"+counter+".refer_date, '%d-%m-%Y'), '%m-%d-%Y') as refer_date";
					 ...
					 for(String value : selectedSearchDTO.getSelectedValues())
					 {
							 ...
							 forUsetables = forUsetables + tableSchema+"tmp_audit_sti_europe";
		    				 forUsetables = forUsetables + " s"+counter+" ,";
						 	 forUseSelect = forUseSelect+", \n"+ 
							                         " s"+counter+"."+value+
									         " as '"+value+"'";
						...
						if(selectedSearchDTO.getGroupId() == 35) 
						{
						if(counter == 1)
						 {
							 forUseSelect = "select DATE_FORMAT(STR_TO_DATE(s"+counter+".refer_date, '%d-%m-%Y'), '%m-%d-%Y') as refer_date";
						 ...
						 for(String value : selectedSearchDTO.getSelectedValues())
						 {
								 ...
								 forUsetables = forUsetables + tableSchema+"tmp_audit_sti_emerging";
			    				 forUsetables = forUsetables + " s"+counter+" ,";
							 	 forUseSelect = forUseSelect+", \n"+ 
								                         " s"+counter+"."+value+
										         " as '"+value+"'";
							...
							if(selectedSearchDTO.getGroupId() == 36) 
							{
							if(counter == 1)
							 {
								 forUseSelect = "select DATE_FORMAT(STR_TO_DATE(s"+counter+".refer_date, '%d-%m-%Y'), '%m-%d-%Y') as refer_date";
							 ...
							 for(String value : selectedSearchDTO.getSelectedValues())
							 {
									 ...
									 forUsetables = forUsetables + tableSchema+"tmp_audit_sti_cryptos";
				    				 forUsetables = forUsetables + " s"+counter+" ,";
								 	 forUseSelect = forUseSelect+", \n"+ 
									                         " s"+counter+"."+value+
											         " as '"+value+"'";
