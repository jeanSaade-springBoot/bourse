...
public class BourseController {
	...
	public BourseController(SovereignYieldsService sovereignYieldsService, GraphHistoryService graphHistoryService,
			DataEntryFilterHistoryService dataEntryFilterHistoryService, SkewsServiceBACK skewsService,
			GraphNewsService graphNewsService, DataFunctionService dataFunctionService,
			CorporatesYieldsService corporatesYieldsService, DynamicTemplateService dynamicTemplateService,
			GraphService graphService, GlobalService globalService) {
	...
	public ModelAndView dataEntryPageFxCds(@RequestParam("fxcds") String fxcds, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("maindatainputnav", "html/templates/dataInputNav");
	...
	public ModelAndView dataEntryPageSkews(@RequestParam("skews") String skews, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("maindatainputnav", "html/templates/dataInputNav");
	...
	public ModelAndView dataEntryPageSti(@RequestParam("sti") String sti, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("maindatainputnav", "html/templates/dataInputNav");
	...
	public ModelAndView dataEntryRatesPage(@RequestParam("rates") String rates, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("maindatainputnav", "html/templates/dataInputNav");
	...
	public ModelAndView dataEntryPageLongEnds(@RequestParam("longend") String longend, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("maindatainputnav", "html/templates/dataInputNav");
	...
	public ModelAndView dataEntryPagecryptos(@RequestParam("cryptos") String cryptos, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("maindatainputnav", "html/templates/dataInputNav");
	...
	public ModelAndView dataEntryPagecryptosFourHoursInterval(@RequestParam("cryptos") String cryptos,
			@RequestParam("interval") String interval, ModelMap model, Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("maindatainputnav", "html/templates/dataInputNav");
		model.addAttribute("datainputmenu", "DATABASE_INPUT_SCREEN_CRYPTOS");
		model.addAttribute("menuId", dynamicTemplateService.getAuthorityId(authentication, "DATABASE_INPUT_SCREEN"));
	...
	public ModelAndView preciousMetalsPage(ModelMap model, Authentication authentication) {
		...
		model.addAttribute("chartNav", "html/fragment/chart-nav");
		model.addAttribute("chartOption", "html/graph/chartOption");
		model.addAttribute("privilege", "PRECIOUS_METALS_GRAPH_SCREEN");
	...
	public ModelAndView cryTradingGraphPage(@RequestParam("isShared") String isShared, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
	...
	public ModelAndView cryBitcoinGraphPage(@RequestParam("isShared") String isShared, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("isShared", isShared);
		model.addAttribute("menuId", dynamicTemplateService.getAuthorityId(authentication, "HOME_SCREEN"));
	...
	public ModelAndView cryEthereumGraphPage(@RequestParam("isShared") String isShared, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("isShared", isShared);
		model.addAttribute("menuId", dynamicTemplateService.getAuthorityId(authentication, "HOME_SCREEN"));
	...
	public ModelAndView crySolanaGraphPage(@RequestParam("isShared") String isShared, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("isShared", isShared);
		model.addAttribute("menuId", dynamicTemplateService.getAuthorityId(authentication, "HOME_SCREEN"));
	...
	public ModelAndView cryShibaGraphPage(@RequestParam("isShared") String isShared, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("isShared", isShared);
		model.addAttribute("menuId", dynamicTemplateService.getAuthorityId(authentication, "HOME_SCREEN"));
	...
	public ModelAndView cryBinanceGraphPage(@RequestParam("isShared") String isShared, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("isShared", isShared);
		model.addAttribute("menuId", dynamicTemplateService.getAuthorityId(authentication, "HOME_SCREEN"));
	...
	public ModelAndView cryXrpGraphPage(@RequestParam("isShared") String isShared, ModelMap model,
			Authentication authentication) {
		model.addAttribute("mainmenu", "html/templates/mainMenu");
		model.addAttribute("isShared", isShared);
		model.addAttribute("menuId", dynamicTemplateService.getAuthorityId(authentication, "HOME_SCREEN"));
	...
	public ResponseEntity<List<SovereignData>> saveData(@RequestBody DataDTO dataDTO) {
		...
		for (String st : lines) {
			...
			SovereignData sovereignData = SovereignData.builder().thirteeYrFactor(strColumn[0])
					.tenYrFactor(strColumn[1]).fiveYrFactor(strColumn[2]).twoYrFactor(strColumn[3])
					.referDate(strColumn[4]).build();
	...
	public ResponseEntity<List<SkewsData>> saveSkews(@RequestBody DataDTO dataDTO) {
		...
		for (String st : lines) {
			String[] strColumn = st.split("\t");
			SkewsData skewsData = SkewsData.builder().referDate(strColumn[0]).fifteenPercentPFactor(strColumn[1])
					.twentyfivePercentPFactor(strColumn[2]).ATMFactor(strColumn[3]).fifteenPercentCFactor(strColumn[4])
					.twentyfivePercentCFactor(strColumn[5]).build();
	...
	public DataEntryFilterHistory saveDataEntryFilterHistory(
			@RequestBody DataEntryFilterHistory dataEntryFilterHistory) {
		DataEntryFilterHistory filterHistory = dataEntryFilterHistoryService
				.SaveDataEntryFilterHistory(dataEntryFilterHistory);
	...
	public boolean updatethirteeyrfactorSovereignBysubgroupIdAndDate(@RequestBody List<UpdateDataDTO> updateDataDTO) {
		...
		for (int i = 0; i < updateDataDTO.size(); i++) {
			sovereignYieldsService.updatethirteeyrfactorSovereignBysubgroupIdAndDate(
					updateDataDTO.get(i).getSubgroupId(), updateDataDTO.get(i).getReferdate(),
					updateDataDTO.get(i).getValue());
		}
		return true;
	}
	...
	public ResponseEntity<Boolean> updateAuditData(@RequestBody List<UpdateDataDTO> updateDataDTOlst) {
		...
		updateDataDTOlst.forEach((updateDataDTO) -> {
			if ((updateDataDTO.getFactor().equalsIgnoreCase("10yr")
					&& updateDataDTO.getSubgroupId().equalsIgnoreCase("1"))
					|| (updateDataDTO.getFactor().equalsIgnoreCase("10yr")
							&& updateDataDTO.getSubgroupId().equalsIgnoreCase("3")))
				;
	...
	public ResponseEntity<List<DataGraphDTO>> findGraphDataForFiveBySubroupId(
			@PathVariable("subgroupId") long subgroupId, @PathVariable("factor") String factor) {
		return new ResponseEntity<>(
				sovereignYieldsService.findGraphDataBySubroupIdAndFactorCalculation(subgroupId, factor), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<CurveSoveriegnDTO>> findSoveriegnCurvesByReferDate(
	...
	public ResponseEntity<List<TmpAuditCorporateYields>> getCorporateAuditData(
			@PathVariable("referDate") String referDate) {
	...
	public ResponseEntity<List<TmpAuditCreditSpreads>> getCreditSpreadAuditData(
			@PathVariable("referDate") String referDate) {
		return new ResponseEntity<>(corporatesYieldsService.findTmpAuditCreditSpreadsByReferDate(referDate),
				HttpStatus.OK);
	}

	@GetMapping(value = "getlatestgraphdate/{country}/{factor}/{yieldCurveCross}")
	public String getLatestGraphDate(@PathVariable("country") long country, @PathVariable("factor") String factor,
			@PathVariable("yieldCurveCross") String yieldCurveCross) {
	...
	public ResponseEntity<List<GraphResponseColConfigListDTO>> getGraphDataListConfig(
			@RequestBody GraphReqDTO graphReqDTO) {
	...
	public Page<AllNewsView> findSelectedGraphNews(@RequestBody GraphNewsDTO graphNewsDTO) {
		return graphNewsService.findSelectedGraphNews(graphNewsDTO.getSelectedGraphs(), graphNewsDTO.getPageNo(),
				graphNewsDTO.getPageSize());
	}
