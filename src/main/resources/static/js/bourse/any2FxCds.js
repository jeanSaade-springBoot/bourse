  ...
  $(document).ready(function () {
	  ...
	  $("div.btn-group-vertical button.btn").click(function(){
	   ...
	   $.ajax({
	        ...
	        url: "/bourse/findgraphhistorybyscreenname/any2FxCds",
	        dataType: 'json',
	        async:true,
	        cache: false,
	        timeout: 600000,
				         ...
				         nbrOfDigits=yaxisformat[0];
				          ...
				          processDataAndAddNewEndDateForExtraSpaceInGraph( data0 ,10,false)
  						  ...
  						  tooltip: {
							   ...
							   renderChartFlagAny2(chart1,0,itemValue[checkedItemValues[0]].img);
								     ...
								     nbrOfDigits=yaxisformat[0];
										 ...
										 series:[{
			    						  ...
			    						  tooltip: {
			      	    	    		   ...
			      	    	    		   renderChartFlagAny2(chart2,0,itemValue[checkedItemValues[1]].img);
		    	  ...
		    	  for(i=0; i<checkedItemid.length; i++)
				   ...
				   for (let i = 0; i < checkedItemValues.length; i++) {
						  ...
						  if (item && item.GroupId === "22") {
						    group22Items.push(checkedItemValues[i]);
						  } else {
...
function renderChartFlagAny2(chart,index,img) {
