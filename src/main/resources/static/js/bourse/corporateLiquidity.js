...
$(document).ready(function() {
   ...
   var functionSource =
	...
	$.ajax({
		...
		url: "/bourse/findgraphhistorybyscreenname/corporateLiquidity",
		dataType: 'json',
		async: true,
		cache: false,
		timeout: 600000,
...
function uncheckAll() {
	      $("#jqxCheckBoxavgUsatoaaaUsa").jqxCheckBox({checked: false });
    	  $("#jqxCheckBoxavgUsbtobbbUsatoaaa").jqxCheckBox({checked: false });
