...
let selectedLiveCurrency = 'SOL'; // default
...
$(document).ready(function() {
	...
	if (timeRange == "Daily") {
		...
		initializeOrderBookForCrypto("SOL");
});
...
function initializeCryptoOptions() {
	...
	$("#dropDownCryptoOptions").jqxDropDownList({ dropDownHeight: 200, selectedIndex: 2, source: functionDataAdapter, placeHolder: "", displayMember: "name", valueMember: "groupId", theme: 'dark', width: 150, height: 25 });
