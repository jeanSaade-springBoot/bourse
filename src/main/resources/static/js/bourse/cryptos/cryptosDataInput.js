...
updateUrl = "/cryptos/update-cryptos-data";
deleteUrl = "/cryptos/delete-cryptos/"+getGroupId(crySubGroupValue)+"/" ;
auditUrl = '/cryptos/cryptos-data/'+getGroupId(crySubGroupValue)+"/" ;
...
function getAuditGridSource(crySubGroupValue) {
	...
	latestUrl = '/cryptos/getlatest/' + groupId;
	$.ajax({
		contentType: "application/json",
		url: latestUrl,
		dataType: 'text',
